...
const AnalysisDashboard: React.FC<AnalysisDashboardProps> = ({
  ...
  const tabs = [
    ...
    { id: 'Semantic Insights', icon: Brain },
  ...
  return (
    <div className="w-full min-h-screen bg-[#050a14] text-white p-6 pb-20 font-inter">
      ...
      {/* SEMANTIC INSIGHTS TAB — always mounted to preserve generated brief */}
      <div style={{ display: activeTab === 'Semantic Insights' ? 'block' : 'none' }}>
        <AIInsightsPanel
          insights={aiInsights}
          computedMetrics={computedMetrics}
          driftData={driftData}
...
` : '\n  Semantic insights available after analysis.'}
